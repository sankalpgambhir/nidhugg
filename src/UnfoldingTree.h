...
#include <config.h>
#ifndef __UNFOLDING_TREE_H__
#define __UNFOLDING_TREE_H__
...
public:
 ...
 public:
  ...
  std::shared_ptr<UnfoldingTree::UnfoldingNode> find_unfolding_node
    (const CPid &cpid,
